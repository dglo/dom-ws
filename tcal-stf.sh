...
#
dorwf=`awk -f /usr/local/share/domhub-tools/dor.awk /tmp/$$.tcal | head -4800 | tr '\n' ' '`
domwf=`awk -f /usr/local/share/domhub-tools/dom.awk /tmp/$$.tcal | head -4800 | tr '\n' ' '`
